...
module Navfund
  Providers = [ABCapital, AsiaUnitedBank, ATRAM, BankOfCommerce, BDO, BPI, ChinaBankSavings, ChinaBank, CTBCBank, Metrobank, Philamlife, PNB, SecurityBank, Sunlife, UCPB, UnionBank]
end
