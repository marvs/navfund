...
module Navfund
  Providers = [ABCapital, AsiaUnitedBank, ATRAM, BankOfCommerce, BDO, BPI, ChinaBankSavings, ChinaBank, Metrobank, Philamlife, PNB, SecurityBank, Sunlife, UCPB, UnionBank]
end
