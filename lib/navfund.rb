...
module Navfund
  Providers = [ABCapital, AsiaUnitedBank, ATRAM, BankOfCommerce, BDO, BPI, ChinaBankSavings, ChinaBank, CTBCBank, DevelopmentBankPh, EastWestBank, Metrobank, Philamlife, PNB, SecurityBank, Sunlife, UCPB, UnionBank]
end
